...
@section('content')
    ...
    <div class="flex flex-col gap-4 pt-[22px]">
        ...
        <div class="flex items-center justify-between">
            ...
            <p class="font-semibold">{{ \Carbon\Carbon::parse($transaction['start_date'])->isoFormat('D MMM YYYY') }}</p>
        </div>
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                <img src="{{ asset('assets/images/icons/calendar.svg') }}" class="w-6 h-6 flex shrink-0" alt="icon">
            ...
            <p class="font-semibold">{{ \Carbon\Carbon::parse($transaction['start_date'])->addMonths(intVal($transaction['duration']))->isoFormat('D MMM YYYY') }}</p>
        </div>
    </div>
    </div>
