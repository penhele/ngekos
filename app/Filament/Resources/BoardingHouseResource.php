                        ...
                        Forms\Components\Tabs\Tab::make('Informasi Umum')
                            ->schema([
                                ...
                                Forms\Components\Select::make('city_id')
                                    ->relationship('city', 'name') // mengambil 'name' dari fungsi city di BoardingHouse.php
                                    ->required(),
                                Forms\Components\Select::make('category_id')
                                    ->relationship('category', 'name') // mengambil 'name' dari fungsi category di BoardingHouse.php
                                    ->required(),
